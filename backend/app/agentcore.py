...
Every wrapper takes an explicit ``client`` so tests can pass a stub that
captures kwargs — no real mutation needed to verify payload shape. The
payloads mirror Lab4_AgentCore_Optimization.ipynb exactly.
"""
